namespace PaymenrOrderAPI.Migrations
{
    ...
    public partial class CreatedPaymentOrderEntity : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        RemitterName = c.String(nullable: false, maxLength: 20),
                        RemitterAddress = c.String(nullable: false, maxLength: 10),
                        RemitterPhoneNumber = c.Int(nullable: false),
                        RemitterIdType = c.String(nullable: false),
                        ...
                        RecepientName = c.String(nullable: false),
                ...
                .PrimaryKey(t => t.OriginatorConversationId);
